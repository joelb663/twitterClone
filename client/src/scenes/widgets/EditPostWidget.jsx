...
const EditPostWidget = ({ id, profilePicturePath, initialPost, onSubmit }) => {
  // State to manage the visibility of the image upload option
  const [isImage, setIsImage] = useState(!!initialPost?.postPicturePath);
  // State to store the description of the post, and selected image file
  const [description, setDescription] = useState(initialPost.description);
  const [image, setImage] = useState(initialPost.postPicturePath);
  ...
  // Handler function for submitting the edited post
  const handleSubmit = () => {
  ...
  return (
    <WidgetWrapper>
      <FlexBetween gap="1.5rem">
        ...
        <InputBase
          placeholder={description || "What's on your mind..."} // Placeholder text for the input
      ...
      <FlexBetween alignItems="center">
        ...
        <Button
          onClick={handleSubmit} // Trigger post submission on button click
